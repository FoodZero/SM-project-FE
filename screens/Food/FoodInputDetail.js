...
const FoodInputDetail = () => {
  ...
  const addfood = async () => {
    ...
    try {
        const response = await axios.post(`http://www.sm-project-refrigerator.store/api/food/${refrigeratorld}`, data, {
...
export default FoodInputDetail;
